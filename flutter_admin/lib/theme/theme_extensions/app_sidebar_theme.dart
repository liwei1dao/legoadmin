...
class AppSidebarTheme extends ThemeExtension<AppSidebarTheme> {
  ...
  ThemeExtension<AppSidebarTheme> copyWith({
    ...
    return AppSidebarTheme(
      ...
      menuSelectedFontColor:
          menuSelectedFontColor ?? this.menuSelectedFontColor,
      menuSelectedBackgroundColor:
          menuSelectedBackgroundColor ?? this.menuSelectedBackgroundColor,
      menuExpandedBackgroundColor:
          menuExpandedBackgroundColor ?? this.menuExpandedBackgroundColor,
      menuExpandedHoverColor:
          menuExpandedHoverColor ?? this.menuExpandedHoverColor,
      menuExpandedChildLeftPadding:
          menuExpandedChildLeftPadding ?? this.menuExpandedChildLeftPadding,
      menuExpandedChildTopPadding:
          menuExpandedChildTopPadding ?? this.menuExpandedChildTopPadding,
      menuExpandedChildRightPadding:
          menuExpandedChildRightPadding ?? this.menuExpandedChildRightPadding,
      menuExpandedChildBottomPadding:
          menuExpandedChildBottomPadding ?? this.menuExpandedChildBottomPadding,
    );
  }
  ...
  ThemeExtension<AppSidebarTheme> lerp(
    ...
    return AppSidebarTheme(
      ...
      menuSelectedFontColor:
          Color.lerp(menuSelectedFontColor, other.menuSelectedFontColor, t)!,
      menuSelectedBackgroundColor: Color.lerp(
          menuSelectedBackgroundColor, other.menuSelectedBackgroundColor, t)!,
      menuExpandedBackgroundColor: Color.lerp(
          menuExpandedBackgroundColor, other.menuExpandedBackgroundColor, t)!,
      menuExpandedHoverColor:
          Color.lerp(menuExpandedHoverColor, other.menuExpandedHoverColor, t)!,
